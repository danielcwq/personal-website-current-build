            ...
            <div className = 'flex flex-col md:flex-row justify-between'>
                <div className = 'md:pl-12'>
                    ...
                    <a className = '' href = 'https://danielching.medium.com/under-the-hood-how-do-neural-networks-really-work-7b48b171dc8c#71eb' target = '_blank'>
                            <div className = 'flex justify-center flex-col flex-grow-0 font-dosis w-3/5 md:w-full rounded-xl mt-10 md:mt-12 shadow-md p-12 pr-12 bg-gray-300 hover:bg-gray-400'>
                                <div className = 'flex justify-center'>
