...
function blogChoice(){
    ...
    <div>
        ...
        <h2 className = 'text-lg md:py-6 sm:px-40'> I’m a 17 year old high school student in Singapore, notorious for the emphasis placed on grades and academic success. This article discusses the ways to optimise your revision progress when you have set aside a period of time to revise. 
        </h2>
...
While reviewing, make sure that there are no distractions around you. Write out your answers on a piece of rough paper, or say the answer out loud, depending on which recall method suits you better.</h2>
        <h1 className = 'text-2xl font-bold pt-8 pb-1 px-40'> 
            Second, practice. This is as crucial, if not more so than the previous step. 
        </h1>
        <h2 className = 'text-lg pb-6 px-40'>
