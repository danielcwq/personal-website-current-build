    ...
    return(
        <div>
            ...
            <div className = 'flex justify-center'>
                <h1 className = 'text-2xl font-extrabold pt-24 py-10 px-4 md:px-4'> Perspectives: Lessons I've learnt from the Filipino Education System </h1>
            </div>
            <h2 className = 'text-lg py-3 px-4 text-justify md:py-6 md:px-40'>
                “Yea. We have three hours of school per day.”
            </h2>
            <h2 className = 'text-lg py-3 px-4 text-justify md:py-6 md:px-40'>
            ...
            <div className = 'flex justify-center'>
                <h3 className = 'md:py-1'> A screenshot of Carlos during our Zoom chat. </h3>
            </div>
            <h2 className = 'text-lg pt-4 px-4 pb-3 md:py-6 md:px-40'> 
            Carlos was someone who was genuinely interested in excelling at what he did - yes, he might have been a standout - yet this burning interest was something that I felt our education system back home was lacking. The question of intrinsic motivation (or type I motivation, as Daniel Pink writes in his book Drive) is something that should be addressed in a child’s formative years of education. Giving students the liberty and freedom to explore different study options instead of brow-beating those who veer off the beaten track is a tenet that our conservative Singaporean society does not possess. Instead, our society focuses on academic achievement, which in my opinion, is considered as a means of extrinsic motivation. If students are unable to see the bigger picture and answer the question of ‘WHY’ they are studying what they are studying, this feeling of dissatisfaction compounds over time. As this is a nuanced concept that needs to be unpacked with greater clarity in the Singaporean context, I would delve further into this in another piece of writing that is in the works. Students who are unable to relate whatever they are learning to how they can apply such knowledge in the real world are the ones suffering the biggest losts. Kudos to MINT for combining students’ passions with real-world impacts. 
            </h2>

            <h2 className = 'text-lg pt-4 px-4 pb-3 md:py-6 md:px-40'> 
            Second, the disparity in stress levels. This is certainly a pain point for countless Singaporean Junior College (JC) students. Suicides in top JCs hushed up, mental health issues frowned upon, the excellence of academic grades over-glorified: all these are characteristic of how students in Singaporean JCs are suffering under crippling stress. What worries us even further is that this phenomenon of sky-high stress levels are spreading to secondary schools, with a SJI boy attempting suicide two weeks ago. If our minds are currently under undue amounts of pressure to perform and excel, how are students expected to grow? Stress + rest = growth. Evidently, the Singaporean society is lacking rest, and once again, lessons can be learnt from our counterparts. To my surprise, I found out from Carlos  that students at MINT College only have to attend 3 hours of lessons per day from 9-12, with Wednesdays as their day off. This absolutely blew my mind. Reflecting back however, it made total sense: if students are able to fully concentrate on lessons for just 3 hours of their time each day, lessons might be able to be taught at a much faster rate. Greater efficiency in teaching content that mattered to students, coupled with the intrinsic - rather than extrinsic - motivation of learning subject matters that one is truly interested in, translates into more time for rest and rejuvenation for the rest of the day. There is a caveat, however: schools in the Philippines are currently shut, and “staring at the computer screen for 3 hours for malaman (meaty) lessons” (as Carlos puts it), might be too intense for some. This still pales in comparison to the amount of time Singaporean students are devoting per week to school work. Imagine having more than twice the amount of time spent in school, counting out the time spent on ad-hoc tuition classes. I am fairly confident that this translates directly into much higher stress levels in Singaporean students. 
            </h2>

            <h2 className = 'text-lg pt-4 px-4 pb-3 md:py-6 md:px-40'>
            This piece of writing is not meant to be a harsh critique on the Singaporean education system, nor is it supposed to be one that lauds the Filipino education system, because both have obvious strengths and weaknesses that I shall not delve into. It is merely to show what is possible - to make education truly enjoyable and relevant to the students who are learning subject content that matters. 
            </h2>
            <h2 className = 'text-lg pt-4 px-4 pb-3 md:py-6 md:px-40'>
            Out of curiosity, I asked Carlos - what was one thing that should be improved in the Filipino education system. He provided a unique viewpoint because of his background as a homeschooled student. Jumping straight into online classes in his first year of actual external schooling, he stated a problem which, I believe, plagued many different countries as well. The lack of funding and resource allocation to the education industry is something that Carlos wishes the Philippines government could be doing. He claims that teachers are severely underpaid for the amount of work that they are doing. 
            </h2>
            <h2 className = 'text-lg pt-4 px-4 pb-3 md:py-6 md:px-40'>
            ...
            <h2 className = 'text-lg pt-4 px-4 pb-3 md:py-6 md:px-40'>
            This is something that I’m really passionate about: a piece of writing diving into more details of some shortcomings of the education system in Singapore is currently in the works. Do drop me a follow on my medium account. Navigate to 'Contact' to find me there!
            </h2>
