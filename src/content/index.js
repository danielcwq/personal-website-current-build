export default {
  ...
  stack: {
    ...
    desc: `I'm a high school graduate from Raffles Institution, Singapore. I'm passionate about all things tech, particularly in the intersection of applied ML in health. I spend a majority of my time reading and meeting like-minded youths from around the world.`,
    ...
    desc3: `As an amateur distance runner who seeks to push my own physical and mental limits, I look for new ways to live a deep and hard life. Additionally, I engage in volunteer coaching, helping Singaporeans get good at their 2.4km run test.`,
